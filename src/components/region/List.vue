        ...
        <tbody>
          <tr
            ...
            <td>
              <router-link
                v-if="item"
                :to="{name: 'RegionShow', params: { id: item['@id'] }}">
                {{ item['@id'] }}
              </router-link>
            </td>
            <td>
...
export default {
  computed: mapGetters({
    deletedItem: 'region/del/deleted',
    error: 'region/list/error',
    items: 'region/list/items',
    isLoading: 'region/list/isLoading',
    view: 'region/list/view'
  }),
