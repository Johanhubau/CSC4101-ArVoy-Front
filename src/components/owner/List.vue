        ...
        <tbody>
          <tr
            ...
            <td>
              <router-link
                v-if="item"
                :to="{name: 'OwnerShow', params: { id: item['@id'] }}">
                {{ item['@id'] }}
              </router-link>
            </td>
            <td>
            ...
            <td>
              <router-link :to="{name: 'OwnerUpdate', params: { id: item['@id'] }}">
                <span
                  class="fa fa-pencil"
                  aria-hidden="true" />
...
export default {
  computed: mapGetters({
    deletedItem: 'owner/del/deleted',
    error: 'owner/list/error',
    items: 'owner/list/items',
    isLoading: 'owner/list/isLoading',
    view: 'owner/list/view'
  }),
