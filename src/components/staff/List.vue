        ...
        <tbody>
          <tr
            ...
            <td>
              <router-link
                v-if="item"
                :to="{name: 'StaffShow', params: { id: item['@id'] }}">
                {{ item['@id'] }}
              </router-link>
            </td>
            <td>
            ...
            <td>
              <router-link :to="{name: 'StaffUpdate', params: { id: item['@id'] }}">
                <span
                  class="fa fa-pencil"
                  aria-hidden="true" />
...
export default {
  computed: mapGetters({
    deletedItem: 'staff/del/deleted',
    error: 'staff/list/error',
    items: 'staff/list/items',
    isLoading: 'staff/list/isLoading',
